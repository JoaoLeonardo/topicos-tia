...
Simple top-down wave based shooter, envisioned as a stealth game, but due to budge and time constraints the guards have already spotted you, so good luck surviving it. Originaly intend only as an university project but I might still add/update a few things, no promises tho.
